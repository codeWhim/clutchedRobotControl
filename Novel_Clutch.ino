...
void loop() {
  ...
  leftCurveForward(2500)
  leftCurveBackward(2500);
  ...
  */
  ...
  //moveForward(3000);
  //moveReverse(3000);
  //turnAroundRight(2000);
  //turnAroundLeft(2000);
  

}

void stopRobot(int seconds){
...
void leftCurveForward(int seconds){
  pwmRear = 127;
  clutch(Disengage,Rear,Left);
  clutch(Engage,Rear,Right);
  clutch(Engage,Front,Left);
...
void leftCurveBackward(int seconds){
  pwmRear = 127;
  reverse = 1;
  right = 1;
  clutch(Disengage,Rear,Left);
